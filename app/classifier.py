...
sel = CustomUnpickler(open('/content/drive/MyDrive/Colab Notebooks/android malware detection/app/static/models/ga.pkl', 'rb')).load()

permissions = []
with open('/content/drive/MyDrive/Colab Notebooks/android malware detection/app/static/permissions.txt', 'r') as f:
    content = f.readlines()
    for line in content:
        cur_perm = line[:-1]
